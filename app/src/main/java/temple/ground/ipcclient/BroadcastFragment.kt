...
import temple.ground.ipcclient.databinding.FragmentBroadcastBinding
import java.util.*
...
class BroadcastFragment : Fragment(), View.OnClickListener {
    ...
    private fun sendBroadcast(){
        val intent = Intent()
        intent.action = "broadcast_palisade"
        ...
        intent.component = ComponentName("temple.ground.ipcserver", "temple.ground.ipcserver.IPCBroadcastReceiver")
